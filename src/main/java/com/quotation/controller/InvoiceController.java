...
public class InvoiceController {
    ...
    public ResponseEntity<?> createInvoice(@RequestBody Invoice invoice) {
     ...
     try {
         ...
         // Get project name and add the "Project:" prefix as requested
         String pName = (savedInvoice.getProjectName() != null) ? savedInvoice.getProjectName() : "General";

         // Use the specific installment amount (TotalPaidAmount)
         double installmentAmount = savedInvoice.getTotalPaidAmount();
         String amountStr = "₹" + String.format("%.2f", installmentAmount);

         // Final Message Format: Invoice INV-101 generated by Emp Name for client Client Name (Project: My Website) - Payment Received: ₹5000.00
         String message = "Invoice " + invNum + " generated by " + empName + 
                          " for client " + client + 
                          " (Project: " + pName + ") - Payment Received: " + amountStr;
